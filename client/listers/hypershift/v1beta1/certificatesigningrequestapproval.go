...
type certificateSigningRequestApprovalLister struct {
	listers.ResourceIndexer[*v1beta1.CertificateSigningRequestApproval]
}
...
func NewCertificateSigningRequestApprovalLister(indexer cache.Indexer) CertificateSigningRequestApprovalLister {
	return &certificateSigningRequestApprovalLister{listers.New[*v1beta1.CertificateSigningRequestApproval](indexer, v1beta1.Resource("certificatesigningrequestapproval"))}
}
...
func (s *certificateSigningRequestApprovalLister) CertificateSigningRequestApprovals(namespace string) CertificateSigningRequestApprovalNamespaceLister {
	return certificateSigningRequestApprovalNamespaceLister{listers.NewNamespaced[*v1beta1.CertificateSigningRequestApproval](s.ResourceIndexer, namespace)}
}
