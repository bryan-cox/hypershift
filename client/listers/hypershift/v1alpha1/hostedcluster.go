...
type HostedClusterLister interface {
	...
	List(selector labels.Selector) (ret []*v1alpha1.HostedCluster, err error)
...
type hostedClusterLister struct {
	listers.ResourceIndexer[*v1alpha1.HostedCluster]
}
...
func NewHostedClusterLister(indexer cache.Indexer) HostedClusterLister {
	return &hostedClusterLister{listers.New[*v1alpha1.HostedCluster](indexer, v1alpha1.Resource("hostedcluster"))}
}

// HostedClusters returns an object that can list and get HostedClusters.
func (s *hostedClusterLister) HostedClusters(namespace string) HostedClusterNamespaceLister {
	return hostedClusterNamespaceLister{listers.NewNamespaced[*v1alpha1.HostedCluster](s.ResourceIndexer, namespace)}
}
...
type HostedClusterNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*v1alpha1.HostedCluster, error)
