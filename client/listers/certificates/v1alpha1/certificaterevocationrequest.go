...
type certificateRevocationRequestLister struct {
	listers.ResourceIndexer[*v1alpha1.CertificateRevocationRequest]
}
...
func NewCertificateRevocationRequestLister(indexer cache.Indexer) CertificateRevocationRequestLister {
	return &certificateRevocationRequestLister{listers.New[*v1alpha1.CertificateRevocationRequest](indexer, v1alpha1.Resource("certificaterevocationrequest"))}
}
...
func (s *certificateRevocationRequestLister) CertificateRevocationRequests(namespace string) CertificateRevocationRequestNamespaceLister {
	return certificateRevocationRequestNamespaceLister{listers.NewNamespaced[*v1alpha1.CertificateRevocationRequest](s.ResourceIndexer, namespace)}
}
