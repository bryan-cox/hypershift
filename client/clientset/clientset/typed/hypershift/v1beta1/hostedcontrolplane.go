...
type hostedControlPlanes struct {
	*gentype.ClientWithListAndApply[*v1beta1.HostedControlPlane, *v1beta1.HostedControlPlaneList, *hypershiftv1beta1.HostedControlPlaneApplyConfiguration]
}
...
func newHostedControlPlanes(c *HypershiftV1beta1Client, namespace string) *hostedControlPlanes {
	return &hostedControlPlanes{
		gentype.NewClientWithListAndApply[*v1beta1.HostedControlPlane, *v1beta1.HostedControlPlaneList, *hypershiftv1beta1.HostedControlPlaneApplyConfiguration](
			"hostedcontrolplanes",
			c.RESTClient(),
