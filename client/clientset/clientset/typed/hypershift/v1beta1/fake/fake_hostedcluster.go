...
var hostedclustersResource = v1beta1.SchemeGroupVersion.WithResource("hostedclusters")

var hostedclustersKind = v1beta1.SchemeGroupVersion.WithKind("HostedCluster")
...
func (c *FakeHostedClusters) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.HostedClusterList, err error) {
	...
	list := &v1beta1.HostedClusterList{ListMeta: obj.(*v1beta1.HostedClusterList).ListMeta}
	for _, item := range obj.(*v1beta1.HostedClusterList).Items {
...
func (c *FakeHostedClusters) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(hostedclustersResource, c.ns, name, opts), &v1beta1.HostedCluster{})
...
func (c *FakeHostedClusters) Apply(ctx context.Context, hostedCluster *hypershiftv1beta1.HostedClusterApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.HostedCluster, err error) {
...
func (c *FakeHostedClusters) ApplyStatus(ctx context.Context, hostedCluster *hypershiftv1beta1.HostedClusterApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.HostedCluster, err error) {
	if hostedCluster == nil {
		return nil, fmt.Errorf("hostedCluster provided to Apply must not be nil")
	}
	data, err := json.Marshal(hostedCluster)
