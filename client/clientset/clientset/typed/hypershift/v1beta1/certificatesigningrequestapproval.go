...
type certificateSigningRequestApprovals struct {
	*gentype.ClientWithListAndApply[*v1beta1.CertificateSigningRequestApproval, *v1beta1.CertificateSigningRequestApprovalList, *hypershiftv1beta1.CertificateSigningRequestApprovalApplyConfiguration]
}
...
func newCertificateSigningRequestApprovals(c *HypershiftV1beta1Client, namespace string) *certificateSigningRequestApprovals {
	return &certificateSigningRequestApprovals{
		gentype.NewClientWithListAndApply[*v1beta1.CertificateSigningRequestApproval, *v1beta1.CertificateSigningRequestApprovalList, *hypershiftv1beta1.CertificateSigningRequestApprovalApplyConfiguration](
