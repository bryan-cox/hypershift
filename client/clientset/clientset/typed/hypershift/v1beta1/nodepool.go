...
type nodePools struct {
	*gentype.ClientWithListAndApply[*v1beta1.NodePool, *v1beta1.NodePoolList, *hypershiftv1beta1.NodePoolApplyConfiguration]
}

// newNodePools returns a NodePools
func newNodePools(c *HypershiftV1beta1Client, namespace string) *nodePools {
	return &nodePools{
		gentype.NewClientWithListAndApply[*v1beta1.NodePool, *v1beta1.NodePoolList, *hypershiftv1beta1.NodePoolApplyConfiguration](
			"nodepools",
			c.RESTClient(),
