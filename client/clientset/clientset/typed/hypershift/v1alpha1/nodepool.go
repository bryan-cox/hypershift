...
type NodePoolInterface interface {
	...
	Apply(ctx context.Context, nodePool *hypershiftv1alpha1.NodePoolApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.NodePool, err error)
	// Add a +genclient:noStatus comment above the type to avoid generating ApplyStatus().
	ApplyStatus(ctx context.Context, nodePool *hypershiftv1alpha1.NodePoolApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.NodePool, err error)
	NodePoolExpansion
}

// nodePools implements NodePoolInterface
type nodePools struct {
	*gentype.ClientWithListAndApply[*v1alpha1.NodePool, *v1alpha1.NodePoolList, *hypershiftv1alpha1.NodePoolApplyConfiguration]
}

// newNodePools returns a NodePools
func newNodePools(c *HypershiftV1alpha1Client, namespace string) *nodePools {
	return &nodePools{
		gentype.NewClientWithListAndApply[*v1alpha1.NodePool, *v1alpha1.NodePoolList, *hypershiftv1alpha1.NodePoolApplyConfiguration](
			"nodepools",
			c.RESTClient(),
