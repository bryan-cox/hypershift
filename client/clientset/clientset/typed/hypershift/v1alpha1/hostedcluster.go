...
type hostedClusters struct {
	*gentype.ClientWithListAndApply[*v1alpha1.HostedCluster, *v1alpha1.HostedClusterList, *hypershiftv1alpha1.HostedClusterApplyConfiguration]
}
...
func newHostedClusters(c *HypershiftV1alpha1Client, namespace string) *hostedClusters {
	return &hostedClusters{
		gentype.NewClientWithListAndApply[*v1alpha1.HostedCluster, *v1alpha1.HostedClusterList, *hypershiftv1alpha1.HostedClusterApplyConfiguration](
			"hostedclusters",
			c.RESTClient(),
			scheme.ParameterCodec,
			namespace,
			func() *v1alpha1.HostedCluster { return &v1alpha1.HostedCluster{} },
			func() *v1alpha1.HostedClusterList { return &v1alpha1.HostedClusterList{} }),
	}
}
