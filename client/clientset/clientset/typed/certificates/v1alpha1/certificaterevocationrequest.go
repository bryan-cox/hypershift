...
type certificateRevocationRequests struct {
	*gentype.ClientWithListAndApply[*v1alpha1.CertificateRevocationRequest, *v1alpha1.CertificateRevocationRequestList, *certificatesv1alpha1.CertificateRevocationRequestApplyConfiguration]
}
...
func newCertificateRevocationRequests(c *CertificatesV1alpha1Client, namespace string) *certificateRevocationRequests {
	return &certificateRevocationRequests{
		gentype.NewClientWithListAndApply[*v1alpha1.CertificateRevocationRequest, *v1alpha1.CertificateRevocationRequestList, *certificatesv1alpha1.CertificateRevocationRequestApplyConfiguration](
