...
type certificateSigningRequestApprovals struct {
	*gentype.ClientWithListAndApply[*v1alpha1.CertificateSigningRequestApproval, *v1alpha1.CertificateSigningRequestApprovalList, *certificatesv1alpha1.CertificateSigningRequestApprovalApplyConfiguration]
}
...
func newCertificateSigningRequestApprovals(c *CertificatesV1alpha1Client, namespace string) *certificateSigningRequestApprovals {
	return &certificateSigningRequestApprovals{
		gentype.NewClientWithListAndApply[*v1alpha1.CertificateSigningRequestApproval, *v1alpha1.CertificateSigningRequestApprovalList, *certificatesv1alpha1.CertificateSigningRequestApprovalApplyConfiguration](
