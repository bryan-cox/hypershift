...
type clusterSizingConfigurations struct {
	*gentype.ClientWithListAndApply[*v1alpha1.ClusterSizingConfiguration, *v1alpha1.ClusterSizingConfigurationList, *schedulingv1alpha1.ClusterSizingConfigurationApplyConfiguration]
}
...
func newClusterSizingConfigurations(c *SchedulingV1alpha1Client) *clusterSizingConfigurations {
	return &clusterSizingConfigurations{
		gentype.NewClientWithListAndApply[*v1alpha1.ClusterSizingConfiguration, *v1alpha1.ClusterSizingConfigurationList, *schedulingv1alpha1.ClusterSizingConfigurationApplyConfiguration](
