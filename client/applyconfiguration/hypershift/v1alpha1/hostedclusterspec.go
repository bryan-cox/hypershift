...
type HostedClusterSpecApplyConfiguration struct {
	...
	ControllerAvailabilityPolicy     *hypershiftv1alpha1.AvailabilityPolicy               `json:"controllerAvailabilityPolicy,omitempty"`
	InfrastructureAvailabilityPolicy *hypershiftv1alpha1.AvailabilityPolicy               `json:"infrastructureAvailabilityPolicy,omitempty"`
	...
	OLMCatalogPlacement              *hypershiftv1alpha1.OLMCatalogPlacement              `json:"olmCatalogPlacement,omitempty"`
...
func (b *HostedClusterSpecApplyConfiguration) WithControllerAvailabilityPolicy(value hypershiftv1alpha1.AvailabilityPolicy) *HostedClusterSpecApplyConfiguration {
...
func (b *HostedClusterSpecApplyConfiguration) WithInfrastructureAvailabilityPolicy(value hypershiftv1alpha1.AvailabilityPolicy) *HostedClusterSpecApplyConfiguration {
...
func (b *HostedClusterSpecApplyConfiguration) WithOLMCatalogPlacement(value hypershiftv1alpha1.OLMCatalogPlacement) *HostedClusterSpecApplyConfiguration {
