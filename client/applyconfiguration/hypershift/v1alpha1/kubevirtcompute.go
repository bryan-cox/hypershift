...
type KubevirtComputeApplyConfiguration struct {
	...
	QosClass *v1alpha1.QoSClass `json:"qosClass,omitempty"`
}
...
func (b *KubevirtComputeApplyConfiguration) WithQosClass(value v1alpha1.QoSClass) *KubevirtComputeApplyConfiguration {
	b.QosClass = &value
	return b
}
