...
type ClusterNetworkingApplyConfiguration struct {
	...
	NetworkType    *hypershiftv1alpha1.NetworkType         `json:"networkType,omitempty"`
...
func (b *ClusterNetworkingApplyConfiguration) WithServiceCIDR(value string) *ClusterNetworkingApplyConfiguration {
	b.ServiceCIDR = &value
	return b
}
...
func (b *ClusterNetworkingApplyConfiguration) WithPodCIDR(value string) *ClusterNetworkingApplyConfiguration {
	b.PodCIDR = &value
	return b
}

// WithMachineCIDR sets the MachineCIDR field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the MachineCIDR field is set to the value of the last call.
func (b *ClusterNetworkingApplyConfiguration) WithMachineCIDR(value string) *ClusterNetworkingApplyConfiguration {
	b.MachineCIDR = &value
	return b
}
...
func (b *ClusterNetworkingApplyConfiguration) WithNetworkType(value hypershiftv1alpha1.NetworkType) *ClusterNetworkingApplyConfiguration {
	b.NetworkType = &value
	return b
}
