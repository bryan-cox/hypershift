...
type KMSSpecApplyConfiguration struct {
	Provider *v1alpha1.KMSProvider              `json:"provider,omitempty"`
...
func (b *KMSSpecApplyConfiguration) WithProvider(value v1alpha1.KMSProvider) *KMSSpecApplyConfiguration {
	b.Provider = &value
	return b
}
