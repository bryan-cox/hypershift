...
type AWSPlatformSpecApplyConfiguration struct {
	...
	Roles                       []AWSRoleCredentialsApplyConfiguration    `json:"roles,omitempty"`
	...
	ControlPlaneOperatorCreds   *v1.LocalObjectReference                  `json:"controlPlaneOperatorCreds,omitempty"`
...
func (b *AWSPlatformSpecApplyConfiguration) WithRoles(values ...*AWSRoleCredentialsApplyConfiguration) *AWSPlatformSpecApplyConfiguration {
	for i := range values {
		if values[i] == nil {
...
func (b *AWSPlatformSpecApplyConfiguration) WithKubeCloudControllerCreds(value v1.LocalObjectReference) *AWSPlatformSpecApplyConfiguration {
...
func (b *AWSPlatformSpecApplyConfiguration) WithNodePoolManagementCreds(value v1.LocalObjectReference) *AWSPlatformSpecApplyConfiguration {
	b.NodePoolManagementCreds = &value
	return b
}

// WithControlPlaneOperatorCreds sets the ControlPlaneOperatorCreds field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the ControlPlaneOperatorCreds field is set to the value of the last call.
func (b *AWSPlatformSpecApplyConfiguration) WithControlPlaneOperatorCreds(value v1.LocalObjectReference) *AWSPlatformSpecApplyConfiguration {
	b.ControlPlaneOperatorCreds = &value
	return b
}
...
func (b *AWSPlatformSpecApplyConfiguration) WithEndpointAccess(value hypershiftv1alpha1.AWSEndpointAccessType) *AWSPlatformSpecApplyConfiguration {
