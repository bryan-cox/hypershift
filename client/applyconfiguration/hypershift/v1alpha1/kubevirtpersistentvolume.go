...
type KubevirtPersistentVolumeApplyConfiguration struct {
	...
	AccessModes  []v1alpha1.PersistentVolumeAccessMode `json:"accessModes,omitempty"`
...
func (b *KubevirtPersistentVolumeApplyConfiguration) WithAccessModes(values ...v1alpha1.PersistentVolumeAccessMode) *KubevirtPersistentVolumeApplyConfiguration {
	for i := range values {
