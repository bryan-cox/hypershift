...
type CertificateRevocationRequestApplyConfiguration struct {
	...
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	Spec                             *CertificateRevocationRequestSpecApplyConfiguration   `json:"spec,omitempty"`
...
func CertificateRevocationRequest(name, namespace string) *CertificateRevocationRequestApplyConfiguration {
	...
	b.WithKind("CertificateRevocationRequest")
	b.WithAPIVersion("certificates.hypershift.openshift.io/v1alpha1")
	return b
}
...
func (b *CertificateRevocationRequestApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
